...
@section('fn' ,  $student->first_name)
@section('mn' ,  $student->middle_name)
@section('ln' ,  $student->last_name)
@section('sn' ,  $student->suffix_name)
      ...
      <div class="col-xl-4">
        ...
        <div class="card">
          <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
            ...
            <h2>{{$student->first_name}} {{$student->middle_name}} {{$student->last_name}} {{$student->suffix_name}}</h2>
            ...
            <div class="tab-content pt-2">
              ...
              <div class="tab-pane fade show active profile-overview" id="profile-overview">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-9 col-md-8">{{$student->first_name}} {{$student->middle_name}} {{$student->last_name}} {{$student->suffix_name}}</div>
                </div>

                <div class="row">
                  <div class="col-lg-3 col-md-4 label">Student Number</div>
                  <div class="col-lg-9 col-md-8">{{$student->student_number}}</div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">{{\Carbon\Carbon::parse($student->birthdate)->format('m-d-Y') }}</div>
                </div>

                <div class="row">
                    <div class="col-lg-3 col-md-4 label">Religion</div>
                    <div class="col-lg-9 col-md-8">{{$student->religion}}</div>
                  </div>
  

                <div class="row">
                  <div class="col-lg-3 col-md-4 label">Street Address</div>
                  <div class="col-lg-9 col-md-8">{{ $student->street_address }}</div>
                </div>
